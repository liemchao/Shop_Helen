...
export const Footer = () => {
  const footer1 = [
    {
      title: "Trang phục biểu diễn Helen",
      sub: [
        "SDT: 0902583722",
        "Gmail: latlat2266@gmail.com",
        "Địa chỉ: 336/24 Nguyễn Văn Luông, phường 12, quận 6, tphcm",
      ],
    },
  ];
  ...
  return (
    <div className={styles.Footerbody}>
      ...
      <div className={styles.footer5}>
        ...
        <p className={styles.bottom}>
          © 2022 www.myntra.com. All rights reserve
        </p>
      </div>
      <hr></hr>
    </div>
